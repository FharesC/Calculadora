...
/* Numero va a manter el numero que ingresemos antes de un operador 
    y la variable op mantendrá la operacion completa ejemplo (25+10-30) */
let numero = ''
let op = ''
...
// Closure: es una función dentro de otra función que tiene acceso al scope o ambito de la funcion padre.
botones.forEach(btn => {
